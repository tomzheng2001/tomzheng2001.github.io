    ...
    return (
        <div id="section4" className="skills">
            <Fragment className="skills__heading">
                <h1 className="skills__heading1">
                    <span style={{ "--k": "1" }}>S</span>
                    <span style={{ "--k": "2" }}>k</span>
                    <span style={{ "--k": "3" }}>i</span>
                    <span style={{ "--k": "4" }}>l</span>
                    <span style={{ "--k": "5" }}>l</span>
                    <span style={{ "--k": "6" }}>s</span>
                    <span
                        style={{
                            "--k": "7",
                            marginLeft: "1rem",
                    ...
                    <span style={{ "--k": "10" }}>C</span>
                    <span style={{ "--k": "11" }}>o</span>
                    <span style={{ "--k": "12" }}>u</span>
                    <span style={{ "--k": "13" }}>r</span>
                    <span style={{ "--k": "14" }}>s</span>
            ...
            <div className="skills__main">
                <div className="skills__main-languages">
                    <h1 className="skills__main-languages-text">Languages</h1>
                    <div className="icons">
                        <svg
                ...
                {/* <div className="skills__main-courses">
                    ...
                    <ul className="classlist">
                        ...
                        <a
                            href="https://inst.eecs.berkeley.edu/~cs61b/fa21/"
                            target="_blank"
                            rel="noreferrer"
                            className="classlist__item"
                        >
                    ...
                    <ul className="classlist">
                        <a
                            href="https://classes.berkeley.edu/content/2021-fall-econ-1-001-lec-001"
                            rel="noreferrer"
                            target="_blank"
                            className="classlist__item"
                        >
                        ...
                        <a
                            href="https://classes.berkeley.edu/content/2021-fall-econ-100a-001-lec-001"
                            rel="noreferrer"
                            target="_blank"
                            className="classlist__item"
                        >
                        ...
                        <a
                            href="https://eml.berkeley.edu/~olney/spring21/econ100b/"
                            rel="noreferrer"
                            target="_blank"
                            className="classlist__item"
                        >
                        ...
                        <a
                            href="http://guide.berkeley.edu/search/?P=econ+140"
                            target="_blank"
                            rel="noreferrer"
                            className="classlist__item"
                        >
                        ...
                        <a
                            href="https://eml.berkeley.edu/~cbrown/e152_sp99/e152_syllabus.html"
                            rel="noreferrer"
                            target="_blank"
                            className="classlist__item"
                        >
                        ...
                        <a
                            href="https://classes.berkeley.edu/content/2021-spring-econ-115-001-lec-001"
                            rel="noreferrer"
                            target="_blank"
                            className="classlist__item"
                        >
